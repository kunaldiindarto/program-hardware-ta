...
# *inisialisasi untuk post Blink
    ...
    def getDataLoop(self, URLloop):
        ...
        print("ini di dalam kelas json untuk ambil data")
        self.stat4 = str(self.data2['stat2'][0]['status'])
...
class Waktu(JsonData):
    ...
    def saveTime(self, ngimput, pressure, kondisi, URLotherloss2):
        ...
        print("ini di dalam method savetTIme buat menampilkan pressure: {}".format(
            self.pressure))
        if __name__ == '__main__':
            if self.ngimput == 'off2' and self.valuee == 0 and self.pressure > 1.5:
                # print("di dalam mehod saveTime -> {}".format(self.ngimput))
            ...
            if self.ngimput == 'on2' and self.valuee != 0 and self.value2 == 0 and self.pressure > 1.5 or self.kondisi != 0:
                # print("di dalam mehod saveTime -> {}".format(self.ngimput))
    ...
    def otherloss2(self, ngimput, pressure, kondisi, URLotherloss):
        ...
        print("ini di dalam method otherloss tidak ada sumber buat menampilkan pressure: {}".format(
            self.pressure))
        if __name__ == '__main__':
            if self.ngimput == 'off2' and self.value3 == 0 and self.pressure <= 1.5:
                # print("di dalam mehod saveTime -> {}".format(self.ngimput))
                # self.x = str(datetime.datetime.now().time())
                self.x = datetime.datetime.now()
                print("now is: {}".format(self.x))
            ...
            if self.ngimput == 'off2' and self.value3 != 0 and self.value4 == 0 and self.pressure > 1.5 or kondisi != 0:
                # print("di dalam mehod saveTime -> {}".format(self.ngimput))
                self.y = datetime.datetime.now()
                # float(self)
                self.jam_end = int(self.y.strftime("%H"))
    ...
    def breakdown(self, ngimput, pressure, kondisi, URLmin, URlfail):
        ...
        print("ini di dalam method breakdown buat menampilkan pressure: {}".format(
            self.pressure))
        if __name__ == '__main__':
            if self.ngimput == 'on2' and self.value5 == 0 and self.pressure <= 1.5:
                # print("di dalam mehod saveTime -> {}".format(self.ngimput))
                # self.x = str(datetime.datetime.now().time())
                self.x = datetime.datetime.now()
                print("now is: {}".format(self.x))
            ...
            if self.ngimput == 'on2' and self.value5 != 0 and self.value6 == 0 and self.pressure > 1.5 or self.kondisi != 0:
                # print("di dalam mehod saveTime -> {}".format(self.ngimput))
                self.y = datetime.datetime.now()
                # float(self)
                self.jam_end = int(self.y.strftime("%H"))
...
time.sleep(11)
URL = "http://polmanpms.online/client2"
URLloop = "http://polmanpms.online/client2/loop"

URLpostBlink = "http://polmanpms.online/client2/postblink"
URLpostOtherloss = "http://polmanpms.online/client2/postotherloss"
URLpostMinor = "http://polmanpms.online/client2/postminorstop"
URLpostFailure = "http://polmanpms.online/client2/postfailure"
...
messageMinFal = "Mesin 2 Breakdown"
kondisi = 0
...
# # ini kondisi ketika startup loss sudah terpenuhi
    if lengkapSensor != timeShutdown and kondisi == 0:
        ...
        if a == 'off2' and value3 == 0 and value4 == 0 and data <= 1.5:
        ...
        elif a == 'off2' and value3 == 1 and value4 == 0 and data > 1.5:  # repeat if
        ...
        elif a == 'off2' and value3 == 1 and value4 == 1 and data > 1.5:  # repeat if
    ...
    # selesai counting trouble
        ...
        if a == 'off2' and value == 0 and value2 == 0 and data > 1.5:  # tambahin diantara jam proses
            zidane.saveTime(a, data, kondisi, URLpostOtherloss)
            print("ini perhitungan downtime awal")
            blinkalarmMesin = "on"
            json.postAlarm(URLpostBlink, blinkalarmMesin, messageOTMP)

        elif a == 'on2' and value == 1 and value2 == 0 and data > 1.5:  # repeat if
        ...
        elif a == 'on2' and value == 1 and value2 == 1 and data > 1.5:  # repeat if
            print("mesin sudah oke, reset nilai value dan value 2")
            zidane.reset1 = 0
            zidane.reset2 = 0
            blinkalarmMesin = ""
    ...
    # selesai counting trouble
        elif a == 'on2' and value == 0 and value2 == 0 and data > 1.5:  # repeat if
            print("mesin sedang running, nilai value dan value 2 tetap di awal")

        # ? -------cek minor stop atau failure----------
        if a == 'on2' and value5 == 0 and value6 == 0 and data <= 1.5:  # tambahin diantara jam proses
        ...
        elif a == 'on2' and value5 == 1 and value6 == 0 and data > 1.5:  # repeat if
            print("ini perhitungan downtime sudah selesai")
            zidane.breakdown(a, data, kondisi, URLpostMinor, URLpostFailure)
            blinkalarmMesin = "off"
            json.postAlarm(URLpostBlink, blinkalarmMesin, messageDone)

        elif a == 'on2' and value5 == 1 and value6 == 1 and data > 1.5:  # repeat if
            print("mesin sudah oke, reset nilai value dan value 2")
            zidane.reset5 = 0
            zidane.reset6 = 0
    ...
    # todo ini elif ketika waktu operating time habis
        ...
        if a == 'off2' and value3 == 1 and value4 == 0 and kondisi != 0:  # repeat if
            print("ini perhitungan downtime sudah selesai")
            zidane.otherloss2(a, data, kondisi, URLpostOtherloss)
        ...
        if a == 'off2' and value3 == 1 and value4 == 1 and kondisi != 0:  # repeat if
            print("mesin sudah oke, reset nilai value dan value 2")
            zidane.reset3 = 0
            zidane.reset4 = 0
            value3 = 0
...
# ?--------------------------------------------------------
        ...
        if a == 'off2' and value == 1 and value2 == 0 and kondisi != 0:  # repeat if
            print("ini perhitungan downtime sudah selesai")
            zidane.saveTime(a, data, kondisi, URLpostOtherloss)
        ...
        if a == 'off2' and value == 1 and value2 == 1 and kondisi != 0:  # repeat if
            print("mesin sudah oke, reset nilai value dan value 2")
            zidane.reset1 = 0
            zidane.reset2 = 0
            value = 0
...
# ?-------------------------------------------------------------
        ...
        if a == 'on2' and value5 == 1 and value6 == 0 and kondisi != 0:  # repeat if
            print("ini perhitungan downtime sudah selesai")
            zidane.breakdown(a, data, kondisi, URLpostMinor, URLpostFailure)
            blinkalarmMesin = "mf"
        ...
        if a == 'on2' and value5 == 1 and value6 == 1 and kondisi != 0:  # repeat if
            print("mesin sudah oke, reset nilai value dan value 2")
            zidane.reset5 = 0
            zidane.reset6 = 0
            value5 = 0
