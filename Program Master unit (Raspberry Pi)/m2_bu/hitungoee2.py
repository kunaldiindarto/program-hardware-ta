...
# *inisialisasi untuk getdataloop
    ...
    def getDataLoop(self, URLloop):
        ...
        self.process = int(self.data2['process']['process2'])
...
# void setup
URLweb = "http://polmanpms.online/client2"
URLloop = "http://polmanpms.online/client2/loop"
URLOee = "http://polmanpms.online/client2/postoee"
...
while True:
    ...
    #     # *speed_loss = pLoss (performance loss), breakdown_loss = 0 (tidak digunakan), downtimeLoss = dtLoss (downtime loss pa wahyu)
        ...
        print("tidak dapat hitung oee karena mesin 2 sudah shutdown")
        # db.resetValue()
    print("program hitungoee2")
    time.sleep(15)
