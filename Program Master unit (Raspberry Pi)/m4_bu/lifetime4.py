...
# *inisialisasi untuk get Blink (mematikan lifetime)
        self.statusBlink = ""
...
URLpostLifetime = "http://polmanpms.online/client/postlifetime"
...
while True:
    ...
    print("status di while true {}".format(status))

    if data == "on4" and status != "sd":
        ...
        print("hari selisih {}".format(hariSelisih))
        ...
        print("date time adalah {}".format(latencyAkhir))
        ...
        if data == "off4" and val != 0 and hariSelisih > 0:
            json.postLT(URLpostLifetime, hariSelisih,
                        jamSelisih, menitSelisih, detikHasil)
            val = 0
        ...
        print("mesin sekarang posisi off atau shutdown")

    print("program lifetime4")
    time.sleep(11.5)
