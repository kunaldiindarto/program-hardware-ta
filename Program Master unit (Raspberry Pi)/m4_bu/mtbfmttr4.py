...
URLpostMaintenance = "http://polmanpms.online/client/postmaintenance"
...
while True:
    ...
    detik = round(hasilLatency.total_seconds(), 2) * 1000

    print("hasil latency adalah {}".format(detik))
    print("hasil latency adalah {}".format(hasilLatency))
    print("date time sekarang adalah {}".format(latencyAkhir))
    print("program mtbfmttr4")
