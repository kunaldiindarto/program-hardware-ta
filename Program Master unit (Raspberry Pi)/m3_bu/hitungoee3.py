...
# *inisialisasi untuk getdataloop
    ...
    def getDataLoop(self, URLloop):
        ...
        self.process = int(self.data2['process']['process3'])
        ...
        print("nilai detik oltotal {}".format(self.detikOlTotal))
...
URLOee = "http://polmanpms.online/client3/postoee"
...
while True:
    ...
    # -----------------------------------------------------
        ...
        otherloss = round(otherlossTotal, 2)
