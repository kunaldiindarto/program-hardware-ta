...
URLpostLifetime = "http://polmanpms.online/client3/postlifetime"
...
while True:
    ...
    if data == "on3" and status != "sd":
        ...
        if data == "off3" and val != 0 and hariSelisih > 0:
            json.postLT(URLpostLifetime, hariSelisih,
                        jamSelisih, menitSelisih, detikHasil)
        ...
        print("mesin 3 sekarang posisi off atau shutdown")

    print("program lifetime 3")
    time.sleep(14)
    # time.sleep(2)
